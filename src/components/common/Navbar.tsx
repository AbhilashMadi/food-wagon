    ...
    <div className="flex h-[60px] items-center justify-between px-[220px] py-[16px]">
      <div className="flex">
        ...
        >
          ...
          >
            <path
              d="M8.89428 26.3647C8.89428 28.366 7.27197 29.9883 5.27075 29.9883C3.26953 29.9883 1.64722 28.366 1.64722 26.3647C1.64722 24.3635 3.26953 22.7412 5.27075 22.7412C7.27197 22.7412 8.89428 24.3635 8.89428 26.3647Z"
              fill="#C4C4C4"
            />
            <path
              d="M26.3533 26.3647C26.3533 28.366 24.731 29.9883 22.7297 29.9883C20.7285 29.9883 19.1062 28.366 19.1062 26.3647C19.1062 24.3635 20.7285 22.7412 22.7297 22.7412C24.731 22.7412 26.3533 24.3635 26.3533 26.3647Z"
              fill="#C4C4C4"
            />
            <path
              fill-rule="evenodd"
        ...
        <div className="text-xl font-semibold text-[#F17228]">
          food <span className="text-[#FFB30E]">wagon</span>
        </div>
      </div>
      <div className="font-xl font-bold">Deliver to:</div>
      <div className="flex gap-[30px]">
        <div className="flex items-center font-semibold">
          <Search size={20} strokeWidth={3} color="#FFB30E" />
          Search Food
        </div>
        <div>
          <button
            className="rounded-md px-[24px] py-[14px]"
